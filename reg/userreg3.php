                            ...
                            <form>
                                ...
                                <div class="row pt-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="name" class="form-control" id="" name="name" placeholder="Enter Name" required pattern="[A-Za-z0-9\s@#$%&*!_]{1,30}" title="use valid name ">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="lastname" class="labelName">Last Name</label>
                                        <input type="name" class="form-control" id="" placeholder="Enter Name" required pattern="[A-Za-z0-9\s@#$%&*!_]{1,30}" title="use valid name">                                    </div>
                                </div>
