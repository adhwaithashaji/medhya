...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Textiles verification</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="login.html">Home</a></li>
          <li class="breadcrumb-item active">Verify Textiles</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
     ...
     <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Textiles Verification</h5>
              

              <?php
              $res=select("select * from registration where email in (SELECT email from login WHERE usertype=4 and STATUS=1)");
              ?>
